...
```bash
git clone https://github.com/alexbalut/bloc-shop-gym-qr-guide.git
...
Credentials: `admin@bloc-shop.demo` / `demo1234`
...
Seed **wipes** gyms, users, machines, and issues, then recreates Bloc Shop Chabanel with 10 machines and sample issues/views.
