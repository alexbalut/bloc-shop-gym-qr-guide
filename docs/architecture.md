...
Seed gym: `bloc-shop`, `primaryColor: #00A3E0`, `secondaryColor: #000000`.

## Multi-tenant gym

Admin session carries `gymId`. APIs scope mutations to that gym. Member home loads slug `bloc-shop` (fallback: first gym).
...
| Workout + history | localStorage keys `bloc-shop-workout:v1:<slug>` and `bloc-shop-workout-history:v1:<slug>` |
